...
- **v2.80.0** (current) — auto mode owns its waits: background gates survive a killed session and re-attach, declared services live and die with the run, and a recovery ladder with budgets it cannot silently reset
