...
- **v2.47.0** (current) — E7A UI fidelity foundation: Playwright capture, pixelmatch comparison, typed contract schema, envelope validator, 5 calibration fixture sets, CI workflow
