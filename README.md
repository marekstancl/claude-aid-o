...
- **v2.67.0** (current) — opt-in test scheduler with staged rollout, real `aid-run-gates.sh` dispatch + escalation, this repo's own `bats_all` remediation evidence + E2E full-path proof, and a PM quarantine-decision-record mechanism (P069).
