...
**Status:** new (PM request, 2026-08-08) — full requirement moved on PM
instruction to `docs/plans/2026-08-02-IMP-AID-ENTRYPOINT-UX-HELP-INIT-SETUP-HANDOFFS.md`
§18, which is the authoritative writeup; this entry is the registry pointer.
**Priority:** high
