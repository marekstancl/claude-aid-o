...
**Status:** new (2026-08-11, doloženo úklidem)

`aid-plan-fsm.sh` umí pracovní kopii vytvořit i odstranit, ale `worktree remove`
volá **jen při chybových stavech** (`:1356` — recovery cesta). Po ÚSPĚŠNÉM
uzavření plánu kopii nikdo neodstraní.
...
**Náprava:** po uzavření plánu (merge do main) kopii odstranit, nebo aspoň
nahlásit jako uklidit-lze. Pozor na zmrazené CP3 kopie — ty jsou důkazní
materiál a mají mít vlastní lhůtu, ne okamžité smazání.
