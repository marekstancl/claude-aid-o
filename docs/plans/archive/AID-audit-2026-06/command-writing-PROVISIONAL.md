...
status: provisional  # P041 Phase 3b draft — awaiting PM sign-off; lives in docs/ until promotion to plugins/aid-orchestrator/skills/command-writing.md with CHANGELOG + version bump
---
