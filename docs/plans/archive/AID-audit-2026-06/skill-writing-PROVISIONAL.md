...
status: provisional  # P041 Phase 4b draft — awaiting PM sign-off and Phase-4 refinement; lives in docs/ until promotion to plugins/aid-orchestrator/skills/skill-writing.md with CHANGELOG + version bump
---
