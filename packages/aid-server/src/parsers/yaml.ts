 ...
 * as warnings in the returned ParseResult. Per §4.0 reliability finding #4,
 * a YAMLException's line is captured (1-indexed) so a queue.yaml with mixed
 * indentation / mojibake surfaces the offending line instead of crashing.
 *
