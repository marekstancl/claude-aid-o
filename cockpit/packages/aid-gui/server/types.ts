...
/**
 * A single line from a `timeline.jsonl` file.
 * Each line is an independent JSON object recording one orchestration event.
 *
 * Source: `.aid-o/work/evidence/{epic_id}/{run_id}/timeline.jsonl`
 */
 ...
 * `state.yaml` (for individual runs).
 *
 * Source: `.aid-o/work/auto-mode-state.yaml`
 *         `.aid-o/work/evidence/{epic_id}/{run_id}/state.yaml`
 */
 ...
 *
 * Source: `.aid-o/work/evidence/{epic_id}/{run_id}/plan.json`
 */
 ...
 *
 * Source: `.aid-o/work/evidence/{epic_id}/{run_id}/state.yaml`
 */
...
export interface StepProgress {
   ...
   * Present in actual state.yaml files (e.g., "steps/step_1_backend/").
   */
  evidence?: string;
}
 ...
 *
 * Source: `.aid-o/work/evidence/{epic_id}/{run_id}/gates_report.json`
 *         `.aid-o/work/evidence/{epic_id}/{run_id}/gates/gates_report.json`
 *
 ...
 *
 * Source: `.aid-o/work/evidence/{epic_id}/{run_id}/pm_decision.json`
 *         `.aid-o/work/evidence/{epic_id}/{run_id}/pm_plan_approval.json`
 */
 ...
 *
 * Source: `.aid-o/work/evidence/{epic_id}/{run_id}/audit-report.md`
 *         `.aid-o/work/evidence/{epic_id}/{run_id}/audit-report.yaml`
 *         `.aid-o/work/evidence/{epic_id}/audit-report.yaml`
 */
 ...
 *
 * Source: `.aid-o/config/queue.yaml`
 */
 ...
 * Derived by aggregating timeline.jsonl entries — not stored directly in a file.
 * True LLM token counts are not available; this tracks proxy metrics.
 *
 * Source: Computed from `.aid-o/work/evidence/{epic_id}/{run_id}/timeline.jsonl`
 */
...
/**
 * A single new entry appended to a `timeline.jsonl` file, detected by
...
/**
 * Usage summary computed from timeline.jsonl files.
 */
