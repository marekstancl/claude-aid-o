 ...
 *
 * Handles: timeline.jsonl, slack_log.jsonl, audit-log.jsonl, and any other
 * JSONL files.
 *
 * No external library required -- parses line by line using built-in
 * JSON.parse. Per §4.0 reliability finding #5, a corrupt line produces a
 * per-line `severity:'warning'` and is skipped, while every valid line is
 * still returned. Empty lines are skipped silently.
 *
