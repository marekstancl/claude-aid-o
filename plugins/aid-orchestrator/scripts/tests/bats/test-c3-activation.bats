...
#   (e)  aid-review-profile.sh exit-22 (range_undetermined) → unverifiable
...
setup() {
  ...
  export FSM
  PREFILTER="$AID_PLUGIN_PATH/scripts/aid-review-profile.sh"
  export PREFILTER
...
# (The invalidation-map cases that followed here were removed by P094 Step 14: the
# invalidation map is gone entirely, PM decision 7A.)
