...
aid_plan_close_render() {
  ...
  local cmd_merge="aid-plan-fsm.sh plan-record-decision ${plan_id} MERGE --by pm && aid-plan-fsm.sh plan-merge-to-main ${plan_id} --decision $(dirname "$decision_path")/pm-plan-decision.json"
