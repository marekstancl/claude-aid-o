...
resolve_mode() {
  ...
  # C3_AUDIT_POLICY overrides the enforcement toggle only — the per-profile
  # c3_required risk-gate always reads the installed default policy, by design
  # (deliberately minimal scope for E-059-1_2).
