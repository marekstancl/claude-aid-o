...
From `.aid-o/04-engine/memory/project-profile.yaml` (generated by `/aid-setup`):

```yaml
paths:
  docs: "docs/"
  frontend: "frontend/"  # or as detected
  backend: "backend/"    # or as detected

tech_stack:
  frontend: "detected by /aid-setup"
  backend: "detected by /aid-setup"
