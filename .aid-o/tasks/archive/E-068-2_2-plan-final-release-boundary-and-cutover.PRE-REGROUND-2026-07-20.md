...
- `plugins/aid-orchestrator/skills/pipeline.md (lines ~1520-1610)`
...
- Modify: `plugins/aid-orchestrator/skills/pipeline.md` (lines ~1520-1610) — replace the per-EPIC release narrative with the mode-conditional plan-final narrative and correct the stale cross-plan enforcement claim at lines 1069-1070.
...
- [ ] [docs-writer] All nine P064 enforcement rows — eight named plus the advisory
