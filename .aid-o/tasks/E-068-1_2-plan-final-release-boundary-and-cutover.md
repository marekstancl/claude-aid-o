...
- `plugins/aid-orchestrator/defaults/schemas/plan-boundary-manifest.schema.json`
...
- `plugins/aid-orchestrator/scripts/lib/aid-plan-manifest.sh`
...
- [ ] [qa] The substitute profile is release-derived: `release_quarantine` contains
